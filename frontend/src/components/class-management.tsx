...
import { Plus, Edit, Trash2, Users, BookOpen, Search, Filter } from "lucide-react"
              ...
              <CardHeader className="pb-3">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <CardTitle className="text-lg leading-none mb-2">{classItem.name}</CardTitle>
                    <div className="flex items-center space-x-2">
                  ...
                  {canEdit && (
                    <div className="flex space-x-1">
                      <Button variant="ghost" size="icon" onClick={() => openEditDialog(classItem)} className="h-8 w-8">
              ...
              <CardContent className="space-y-4">
                ...
                {classTeacher && (
                  <div className="p-3 bg-muted rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">{classTeacher.fullName}</p>
                    <p className="text-xs text-muted-foreground">{classTeacher.subject}</p>
                  </div>
                )}
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <strong>{deletingClass?.name}</strong> and all associated data.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
